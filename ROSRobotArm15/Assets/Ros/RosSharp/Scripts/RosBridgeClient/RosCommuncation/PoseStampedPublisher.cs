...
namespace RosSharp.RosBridgeClient
{
    public class PoseStampedPublisher : Publisher<Messages.Geometry.PoseStamped>
    {
        ...
        public Messages.Geometry.PoseStamped message;
        ...
        {
            UpdateMessage();
            //Debug.Log("tool0 Position: " + PublishedTransform.transform.position + ", Rotation: " + PublishedTransform.transform.rotation);

            //Debug.Log("tool0 Local Position X: " + PublishedTransform.transform.localPosition.x + ", Y: " + PublishedTransform.transform.localPosition.y + ", Z: " + PublishedTransform.transform.localPosition.z);
            //Debug.Log("tool0 Local Rotation X: " + PublishedTransform.transform.localRotation.x + ", Y: " + PublishedTransform.transform.localPosition.y + ", Z: " + PublishedTransform.transform.localRotation.z);
        }
